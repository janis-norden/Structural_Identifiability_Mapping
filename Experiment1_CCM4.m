...
sysID = dynamical_system('CCM4', 'ID');              % select example model and identifiability status
sysUID = dynamical_system('CCM4', 'UID');

disp('Running experiment 1 - CCM4')                  % display running message
...
experimentPars.numTrExVec = [10:20:100, 100:100:dataGenPars.numExamples.train];   
...
if loadResults & analysis_mode
    load('Results/prExperiment1_CCM4_202506281947.mat')
...
if analysis_mode
    ...
    print(gcf, '-dpdf', 'Figures/Exp1_CCM4.pdf');
end
