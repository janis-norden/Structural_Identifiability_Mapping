...
sysID = dynamical_system('CML', 'ID');               % select example model and identifiability status
sysUID = dynamical_system('CML', 'UID');

disp('Running experiment 1 - CML')                   % display running message
...
if loadResults & analysis_mode
    load('Results/prExperiment1_CML_202506290218.mat')
...
if analysis_mode
    ...
    print(gcf, '-dpdf', 'Figures/Exp1_CML.pdf');
end
