...
sysUID = dynamical_system('CCM4', 'UID');            % select example model and identifiability status

disp('Running experiment 2 - CCM4')                  % display running message
...
dataGenPars.numExamples.train = 400;            % fixed for this experiment
...
if loadResults & analysis_mode
    load('Results/pExperiment2_CCM4_202411120249.mat')
...
options.xLimits = [8 dataGenPars.sigmaObsVec(end-1)];
...
if analysis_mode
    ...
    print(gcf, '-dpdf', 'Figures/Exp2_CCM4.pdf');
end
